...
class AdminChatHistoryPage extends StatefulWidget {
  final String uid;

  AdminChatHistoryPage({Key? key, required this.uid}) : super(key: key);

  @override
  _AdminChatHistoryPageState createState() => _AdminChatHistoryPageState();
}

class _AdminChatHistoryPageState extends State<AdminChatHistoryPage> {
